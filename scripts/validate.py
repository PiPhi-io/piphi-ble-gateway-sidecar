...
from piphi_ble_gateway_sidecar.contract import COMMANDS, ENDPOINTS, REQUIRED_ENDPOINTS
...
is_sidecar = manifest.get("metadata", {}).get("domain") == "sidecar-service"

if behavior is None and not is_sidecar:
